 ...
 *************************************************************************/
struct conscell * buscrmde(struct conscell *form)
{      long int mode;
 ...
 *************************************************************************/
struct conscell * buscrsap(struct conscell *form)
{      long int page;
 ...
 *************************************************************************/
struct conscell * buscrspt(struct conscell *form)
{      long int a,b,c;
 ...
 *************************************************************************/
struct conscell * buscrsct(struct conscell *form)
{      long int a,b;
       if ((form!=NULL)&&(GetFix(form->carp,&a)))
       {    form = form->cdrp;
 ...
 *************************************************************************/
struct conscell * buscrscp(struct conscell *form)
{      long int p,r,c;
 ...
 *************************************************************************/
struct conscell * buscrwdot(struct conscell *form)
{      long int r,c,a;
       if ((form!=NULL)&&(GetFix(form->carp,&r)))
       {    form = form->cdrp;
 ...
 *************************************************************************/
struct conscell * buscrline(struct conscell *form)
